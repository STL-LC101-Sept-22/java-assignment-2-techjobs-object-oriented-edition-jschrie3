...
// TODO 1: Modify line 5 to extend the JobField class into (CoreCompetency).

public class CoreCompetency extends JobField {

    // TODO 2: Next, remove any code in (CoreCompetency) that matches code from JobField (e.g. the id, value, and nextId fields are shared).
